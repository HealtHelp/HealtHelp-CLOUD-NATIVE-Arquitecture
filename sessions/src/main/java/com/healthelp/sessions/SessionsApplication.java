...
public class SessionsApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		new Sessions(new Date(),1,"Diagnosis 3","Exploration 3","Treatment 3","Reason 3","Background 3","Complementary 3"),
		new Sessions(new Date(),1,"Diagnosis 4","Exploration 4","Treatment 4","Reason 4","Background 4","Complementary 4")
